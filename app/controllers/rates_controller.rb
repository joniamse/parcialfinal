class RatesController < ApplicationController
  ...
  def destroy
    ...
    if count == 0
      ...
      respond_to do |format|
        format.html { redirect_to rates_url, notice: "Rate was not successfully destroyed because has payments assigned." }
        format.json { head :no_content }
      end
    end
  end
  ...
  private
    ...
    def rate_params
      params.require(:rate).permit(:amount, :car_id)
    end
end
